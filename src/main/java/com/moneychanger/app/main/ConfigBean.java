...
public class ConfigBean {
    ...
    private final static String KEY_PASSWORD_IMAGE = "PasswordImage";
...
//----------------------------------------------------------------------------
    ...
    // </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="OT Path">
    ...
    // </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="ZMQ Path">
    ...
    // </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="User Data Path">
    ...
    // </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="Password Image File">
    public String passwordImageInfo() {
        return "The image file that contains the password image data.";
    }

    public String passwordImageRegex() {
        return "(.)*";
    }

    public String getPasswordImage() {
        return _prefs.get(KEY_PASSWORD_IMAGE, null);
    }

    public void setPasswordImage(String name) {
        _prefs.put(KEY_PASSWORD_IMAGE, name);
    }
    // </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="Wallet Filename">
    ...
    // </editor-fold>
    // <editor-fold defaultstate="collapsed" desc="Config Updated Boolean">
