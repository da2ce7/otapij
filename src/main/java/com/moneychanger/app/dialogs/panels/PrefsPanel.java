 ...
 */
package com.moneychanger.app.dialogs.panels;

import com.moneychanger.app.controlers.PrefsController.ActionKeys;
import com.moneychanger.app.controlers.PrefsController.FieldKeys;
...
public class PrefsPanel extends javax.swing.JPanel {
    ...
    private void bindActions()
    {
        ...
        jButton_PasswordImage.setAction(_viewModel.getButtonAction(ActionKeys.IMAGEBROWSE));
    }
    ...
    private void bindFields(){
        ...
        _viewModel.bindValidatedDoc(FieldKeys.IMAGEDIR, jTextField_PasswordImage.getDocument(), new FieldValidationChange(){
            @Override
            public void fieldValidationState(boolean valid) {
                if (valid)jTextField_PasswordImage.setBackground(Color.white);
                if (!valid)jTextField_PasswordImage.setBackground(Color.yellow);
            }
        });
    ...
    private void setToolTips()
    {
        ...
        jTextField_PasswordImage.setToolTipText(_viewModel.getFieldInfo(FieldKeys.IMAGEDIR));
    }
    ...
    private void initComponents() {
        ...
        jLabel_PrefPanel.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        ...
        jTextField_TimeOut.setMaximumSize(new java.awt.Dimension(240, 20));
        ...
        jTextField_Wallet.setMaximumSize(new java.awt.Dimension(240, 20));
        ...
        jTextField_UserData.setMaximumSize(new java.awt.Dimension(240, 20));
        ...
        jTextField_Libraries.setMaximumSize(new java.awt.Dimension(240, 20));
        ...
        jLabel_PasswordImage.setLabelFor(jLabel_Wallet);
        jLabel_PasswordImage.setText("Password Image");
        jLabel_PasswordImage.setName("jLabel_PasswordImage");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridwidth = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_END;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(3, 5, 3, 5);
        add(jLabel_PasswordImage, gridBagConstraints);

        jTextField_PasswordImage.setEditable(false);
        jTextField_PasswordImage.setText("Password Image File Location");
        jTextField_PasswordImage.setMaximumSize(new java.awt.Dimension(240, 20));
        jTextField_PasswordImage.setName("jTextField_PasswordImage");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridwidth = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(3, 5, 3, 5);
        add(jTextField_PasswordImage, gridBagConstraints);
        ...
        jButton_PasswordImage.setText("Select Image");
        jButton_PasswordImage.setName("jButton_PasswordImage");
        jButton_PasswordImage.setPreferredSize(new java.awt.Dimension(100, 24));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridwidth = 2;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(3, 10, 3, 10);
        add(jButton_PasswordImage, gridBagConstraints);
    ...
    private final javax.swing.JButton jButton_PasswordImage = new javax.swing.JButton();
    ...
    private final javax.swing.JLabel jLabel_PasswordImage = new javax.swing.JLabel();
    ...
    private final javax.swing.JTextField jTextField_PasswordImage = new javax.swing.JTextField();
