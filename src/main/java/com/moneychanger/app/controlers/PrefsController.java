...
import com.moneychanger.app.controlers.PrefsController.ValidationGroups.CheckedFields;
import com.moneychanger.app.dialogs.panels.PrefsPanel;
import com.moneychanger.app.main.Concierge;
import com.moneychanger.app.main.ConfigBean;
import com.moneychanger.app.main.helpers.AppdataDirectory;
import com.moneychanger.app.main.helpers.OSType;
...
public class PrefsController {
    ...
    public enum ActionKeys {
        ...
        OK, CANCEL, BROWSE, LIBRARIES, IMAGEBROWSE
    }

    public enum FieldKeys {

        OTLIB, TIMEOUT, USERDATA, WALLET, IMAGEDIR
    };
    // </editor-fold>
    ...
    private static class Fields extends AbstractFields<FieldKeys> {
        ...
        private void buildAcceptAction() {
            ...
            _chekedAcceptAction.addItemToCheck(FieldKeys.IMAGEDIR);
//            _chekedAcceptAction.addItemToCheck(FieldKeys.OTLIB);
    ...
    private static class Actions extends AbstractActions<FieldKeys, ActionKeys> {
        ...
        private void buildActions() {
            ...
            _actionsMap.put(ActionKeys.IMAGEBROWSE, new ImageBrowseAction());
        }
        ...
        public class ImageBrowseAction extends AbstractAction {

            private JFileChooser pathFolderChooser;

            public ImageBrowseAction() {
                super("Find Image");
                pathFolderChooser = new JFileChooser();
                pathFolderChooser.setCurrentDirectory(new java.io.File("."));
                pathFolderChooser.setFileSelectionMode(JFileChooser.OPEN_DIALOG);
            }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (returnVal == JFileChooser.APPROVE_OPTION) {
                    _fields.updateFieldDoc(FieldKeys.IMAGEDIR, pathFolderChooser.getSelectedFile().getPath());
    ...
    private static final class PrefsModel {
        ...
        public void setDefaltValues(ConfigBean configBean) {
            ...
            if (configBean.getPasswordImage() == null
                    || configBean.getPasswordImage().isEmpty()) {
                configBean.setPasswordImage("testimage.png");
            }
        ...
        private void buildConfigViewModel() {
            ...
            _localConfigViewModel.put(FieldKeys.IMAGEDIR, _configBean.getPasswordImage());
        }
        ...
        private void buildInfoViewModel() {
            ...
            _localInfoViewModel.put(FieldKeys.IMAGEDIR, _configBean.passwordImageInfo());
        }
        ...
        private void buildRegexViewModel() {
            ...
            _localRegexViewModel.put(FieldKeys.IMAGEDIR, _configBean.passwordImageRegex());
        }
        ...
        public void setConfig() {
            ...
            _configBean.setPasswordImage(_localConfigViewModel.get(FieldKeys.IMAGEDIR));
