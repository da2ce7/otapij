...
public class ServerInfoTableModel extends DefaultTableModel implements WrapperTableModel {
        private String[] columnNames = {"Server ID","Server Type"};
        private Object[][] data;
    ...
    @Override
    public void insertRow(int index,Object[] aValue) {
