...
public class MarketRecentTradesTableModel extends DefaultTableModel implements WrapperTableModel {
    ...
    private String[] columnNames = {"Txn ID", "Price", "Quantity", "Total Value", "Date"};
    private Object[][] data;
    /*private Object[][] data = {
    {"Asset1","100"},
    {"Server2","200"},
   ...
   public MarketRecentTradesTableModel(JTable recentTradesTable){
    ...
    public void setValue(List values, JTable recentTradesTable) {
        ...
        clearValue();
        System.out.println("recenTrades setValue, values.size():" + values.size());
        data = new Object[values.size()][];
        for (int i = 0, j = values.size() - 1; j >= 0; j--, i++) {
    ...
    public void setValue(Map values, JTable recentTradesTable) {
