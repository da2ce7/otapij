 ...
 * @author Vicky C
 */
public class NYMOutboxTableModel extends AbstractTableModel implements WrapperTableModel {

        private String[] columnNames = {"Subject" , "To", "Server Name","Unique ID","NYM ID","Server ID"};
