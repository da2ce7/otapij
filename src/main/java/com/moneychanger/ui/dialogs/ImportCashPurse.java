 ...
 * @author Vicky C
 */
public class ImportCashPurse extends javax.swing.JDialog {
    ...
    /** Creates new form ImportCashPurse */
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.moneychanger.app.LaunchMoneychanger.class).getContext().getResourceMap(ImportCashPurse.class);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ImportCashPurse dialog = new ImportCashPurse(new javax.swing.JFrame(), true,"","","","");
