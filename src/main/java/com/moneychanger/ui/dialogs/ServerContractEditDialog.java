 ...
 * @author Vicky C
 */
public class ServerContractEditDialog extends javax.swing.JDialog {
    private String serverID;

    /** Creates new form ServerContractEditDialog */
    public ServerContractEditDialog(java.awt.Frame parent, boolean modal,String serverID) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.moneychanger.app.ApplicationLauncher.class).getContext().getResourceMap(ServerContractEditDialog.class);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ServerContractEditDialog dialog = new ServerContractEditDialog(new javax.swing.JFrame(), true,"");
