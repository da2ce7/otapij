...
/*
 * SendTransferDialog.java
 *
 * Created on 7 Apr, 2011, 6:25:07 AM
 */
 ...
 * @author Vicky C
 */
public class SendTransferDialog extends javax.swing.JDialog {
    private final String serverID;
    private final String nymID;
    private final String accountID;
    private Map accountMap;

    /** Creates new form SendTransferDialog */
    public SendTransferDialog(java.awt.Frame parent, boolean modal,String serverID,String nymID,String accountID) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.moneychanger.app.LaunchMoneychanger.class).getContext().getResourceMap(SendTransferDialog.class);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SendTransferDialog dialog = new SendTransferDialog(new javax.swing.JFrame(), true,"","","");
