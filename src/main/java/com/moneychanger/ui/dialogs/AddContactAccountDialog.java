...
public class AddContactAccountDialog extends javax.swing.JDialog {
    ...
    /** Creates new form AddContactAccountDialog */
    /**
     *
     * @param parent
     * @param modal
     ...
     *              >=0 for edit
     */
    public AddContactAccountDialog(java.awt.Frame parent, boolean modal,String contactID,int index) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.moneychanger.app.ApplicationLauncher.class).getContext().getResourceMap(AddContactAccountDialog.class);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddContactAccountDialog dialog = new AddContactAccountDialog(new javax.swing.JFrame(), true,"",-1);
